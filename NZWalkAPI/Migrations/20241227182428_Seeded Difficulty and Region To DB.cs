...
{
    /// <inheritdoc />
    public partial class SeededDifficultyandRegionToDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2791b9dc-f17a-4f67-98ee-79f5477d21ce"), "Medium" },
                    { new Guid("28c50daa-4b44-4d0d-ae98-17aad8cb2ded"), "Hard" },
                    { new Guid("7f5f0b56-2a5b-4186-9d8a-83d933e86394"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("2791b9dc-f17a-4f67-98ee-79f5477d21ce"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("28c50daa-4b44-4d0d-ae98-17aad8cb2ded"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("7f5f0b56-2a5b-4186-9d8a-83d933e86394"));
